...
($(window).resize(function () {
  ...
  $(document).ready(function () {
    ...
    var e = 'erenovic-theme',
      t = document.documentElement,
      n = $('#theme-toggle');
    if (n.length) {
      var i = n.find('.theme-toggle__icon'),
        o = n.find('.theme-toggle__label'),
        a = function (e) {
          var t = 'dark' === e;
          n.attr('aria-pressed', t),
            i.text(t ? '☀️' : '🌙'),
            o.text(t ? 'Light' : 'Dark');
        },
        r = function (n, r) {
          if ((void 0 === r && (r = !0), t.setAttribute('data-theme', n), a(n), r))
            try {
              window.localStorage.setItem(e, n);
            } catch (e) {}
        },
        s = 'dark' === t.getAttribute('data-theme') ? 'dark' : 'light';
      r(s, !1),
        n.on('click', function () {
          var e = 'dark' === t.getAttribute('data-theme') ? 'dark' : 'light';
          r('dark' === e ? 'light' : 'dark');
        });
    }
  }));
